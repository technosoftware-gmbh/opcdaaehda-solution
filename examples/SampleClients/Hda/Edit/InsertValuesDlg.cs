...
namespace SampleClients.Hda.Edit
{
	...
	/// </summary>
	public class InsertValuesDlg : System.Windows.Forms.Form
	{
		...
		/// </summary>
		public bool ShowDialog(TsCHdaServer server, bool replace, bool synchronous)
		{
			return ShowDialog(server, null, replace, synchronous);
		}
